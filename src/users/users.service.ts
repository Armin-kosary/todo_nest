...
export class UsersService {
  ...
  async createNewUser(createUserDto: CreateUserDto) {
    const checkUserAvailability = await this.findUserByUserName(
  ...
  async updateUser(
    ...
    if (!findUser || userId != requestSenderId)
      throw new BadRequestException('there was a problem while updating');
